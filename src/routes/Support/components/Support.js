...
const Support = (props) => {
  return (
    <div className='supportview'>
      ...
      <p>Use Carbcut, e.g. with students in your class or to engage your colleagues in a reflective discussion of portfolio thinking in climate policy decision making.</p>
      ...
      <Button className='readmore btn-lg' bsStyle='primary' style={{'float': 'right'}}>Read more</Button>
      ...
      <h3>--- read more napilla avatta teksti loppuu tähän ---</h3>
